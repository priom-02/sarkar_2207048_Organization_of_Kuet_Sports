...
<head>
    ...
    <title>Add Gallery Photo - Admin</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="form-card">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Brief description of the photo"></textarea>
                </div>
                
                <div class="button-group">
                    <button type="submit" class="btn btn-submit">Upload Photo</button>
